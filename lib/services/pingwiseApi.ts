...
class PingwiseApiService {
  ...
  async getUsers(): Promise<ApiUser[]> {
    return this.api.get<ApiUser[]>('/users') as unknown as ApiUser[];
  }
  ...
  async getUser(id: string): Promise<ApiUser> {
    return this.api.get<ApiUser>(`/users/${id}`) as unknown as ApiUser;
  }
  ...
  async createUser(data: CreateUserRequest): Promise<ApiUser> {
    return this.api.post<ApiUser>('/users', data) as unknown as ApiUser;
  }
   ...
   * PUT /users/{id}
   */
  async updateUser(id: string, data: CreateUserRequest): Promise<ApiUser> {
    return this.api.put<ApiUser>(`/users/${id}`, data) as unknown as ApiUser;
  }
