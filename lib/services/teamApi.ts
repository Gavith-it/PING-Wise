 ...
 * Separate service from CRM API as per user requirements.
 */
...
class TeamApiService {
  ...
  constructor() {
    this.baseURL = '/api/teams'; // Use Next.js API proxy route
  ...
  async getTeams(): Promise<CrmApiListResponse<CrmTeam>> {
    try {
      const response = await this.api.get<any>('') as unknown as any;
  ...
  async getTeam(id: number | string): Promise<CrmApiSingleResponse<CrmTeam>> {
    const response = await this.api.get<any>(`/${id}`) as unknown as any;
  ...
  async createTeam(data: CrmTeamRequest): Promise<CrmApiSingleResponse<CrmTeam>> {
    const response = await this.api.post<any>('', data) as unknown as any;
    return response.data || response; // Handle wrapped or direct response
  }
  ...
  async updateTeam(id: number | string, data: CrmTeamRequest): Promise<CrmApiSingleResponse<CrmTeam>> {
    const response = await this.api.put<any>(`/${id}`, data) as unknown as any;
    return response.data || response; // Handle wrapped or direct response
  }
  ...
  async deleteTeam(id: number | string): Promise<CrmApiStringResponse> {
    const response = await this.api.delete<any>(`/${id}`) as unknown as any;
    return response.data || response; // Handle wrapped or direct response
  }
}
