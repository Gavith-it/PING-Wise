...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className={`${isCRM ? 'h-screen overflow-hidden' : 'min-h-screen'} bg-gray-50 dark:bg-gray-900 flex flex-col`}>
      <Header />
      <main className={`flex-1 ${isCRM ? 'pb-16 md:pb-0 overflow-hidden min-h-0' : 'pb-24 md:pb-4'}`}>
