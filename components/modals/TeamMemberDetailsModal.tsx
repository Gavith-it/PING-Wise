      ...
      <div className="bg-white rounded-xl md:rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        <div className="p-4 md:p-6">
          ...
          <div className="flex items-center justify-between mb-4 md:mb-6">
            <h3 className="text-lg md:text-xl font-bold text-gray-900">Team Member Details</h3>
            <button
              onClick={onClose}
          ...
          <div className="space-y-4 md:space-y-6">
            {/* Profile Section */}
            <div className="flex items-start gap-3 md:gap-4 pb-4 md:pb-6 border-b border-gray-200">
              ...
              <div className="flex-1 min-w-0">
                <h4 className="text-lg md:text-xl font-bold text-gray-900 mb-1">{teamMember.name}</h4>
                <p className="text-sm md:text-base text-gray-600 mb-2">{teamMember.role}</p>
                {teamMember.rating && (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
              ...
              <div className="flex items-start gap-2 md:gap-3">
                ...
                <div className="min-w-0">
                  <p className="text-xs md:text-sm text-gray-500 mb-0.5">Email</p>
                  <p className="text-sm md:text-base text-gray-900 break-words">{teamMember.email}</p>
                </div>
              </div>

              {/* Phone */}
              <div className="flex items-start gap-2 md:gap-3">
                <Phone className="w-4 h-4 md:w-5 md:h-5 text-gray-400 flex-shrink-0 mt-0.5" />
                <div className="min-w-0">
                  <p className="text-xs md:text-sm text-gray-500 mb-0.5">Phone</p>
                  <p className="text-sm md:text-base text-gray-900">{teamMember.phone || 'N/A'}</p>
                </div>
              </div>

              {/* Department */}
              <div className="flex items-start gap-2 md:gap-3">
                <Briefcase className="w-4 h-4 md:w-5 md:h-5 text-gray-400 flex-shrink-0 mt-0.5" />
                <div className="min-w-0">
                  <p className="text-xs md:text-sm text-gray-500 mb-0.5">Department</p>
                  <p className="text-sm md:text-base text-gray-900">{teamMember.department || 'N/A'}</p>
                </div>
              </div>
              ...
              {teamMember.specialization && (
                <div className="flex items-start gap-2 md:gap-3">
                  <Award className="w-4 h-4 md:w-5 md:h-5 text-gray-400 flex-shrink-0 mt-0.5" />
                  <div className="min-w-0">
                    <p className="text-xs md:text-sm text-gray-500 mb-0.5">Specialization</p>
                    <p className="text-sm md:text-base text-gray-900">{teamMember.specialization}</p>
                  </div>
                </div>
              )}
              ...
              {teamMember.experience && (
                <div className="flex items-start gap-2 md:gap-3">
                  <Award className="w-4 h-4 md:w-5 md:h-5 text-gray-400 flex-shrink-0 mt-0.5" />
                  <div className="min-w-0">
                    <p className="text-xs md:text-sm text-gray-500 mb-0.5">Experience</p>
                    <p className="text-sm md:text-base text-gray-900">{teamMember.experience}</p>
                  </div>
                </div>
              )}
              ...
              {/* Appointment Count */}
              <div className="flex items-start gap-2 md:gap-3">
                <Calendar className="w-4 h-4 md:w-5 md:h-5 text-gray-400 flex-shrink-0 mt-0.5" />
                <div className="min-w-0">
                  <p className="text-xs md:text-sm text-gray-500 mb-0.5">Appointments Held</p>
                  <p className="text-sm md:text-base text-gray-900 font-semibold">{appointmentCount}</p>
                </div>
              </div>
          ...
          {/* Actions */}
          <div className="flex flex-col sm:flex-row gap-2 md:gap-3 pt-4 md:pt-6 mt-4 md:mt-6 border-t border-gray-200">
            <button
              onClick={() => {
                onEdit(teamMember);
                onClose();
